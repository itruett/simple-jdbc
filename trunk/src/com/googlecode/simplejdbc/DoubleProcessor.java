 ...
 */
public class DoubleProcessor extends AbstractSingleRecordProcessor<Double> {
	 ...
	 * @param columnName
	 */
	public DoubleProcessor(final String columnNamePrefix, final String columnName) {
	 ...
	 * @param columnName
	 */
	public DoubleProcessor(final String columnName) {
		this("", columnName);
	}
